...
describe('state transitions', () => {
  ...
  describe('create_todo', () => {
    ...
    it('removes character on backspace', () => {
      const state = { ...createInitialState(), view: 'create_todo' as const, inputBuffer: 'hello' }
    ...
    it('creates todo on SUBMIT with non-empty buffer', () => {
      const state = { ...createInitialState(), view: 'create_todo' as const, inputBuffer: 'My Todo' }
    ...
    it('does not create todo on SUBMIT with empty buffer', () => {
      const state = { ...createInitialState(), view: 'create_todo' as const, inputBuffer: '' }
      const next = transition(state, { type: 'SUBMIT' })
      assert.strictEqual(next.view, 'create_todo')
  ...
  describe('load_todo', () => {
    ...
    it('navigates through todo list', () => {
      ...
      const state = { ...createInitialState(), view: 'load_todo' as const, todos, menuIndex: 0 }
  ...
  describe('global actions', () => {
    it('QUIT transitions to quit from any view', () => {
      const views = ['main_menu', 'create_todo', 'load_todo', 'view_todo'] as const
